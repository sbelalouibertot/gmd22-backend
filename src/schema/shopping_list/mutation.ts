...
import {
  toggleCheckShoppingListFood,
  TToggleCheckShoppingListFoodInput,
} from '../../service/shoppingList/toggleCheckShoppingListFood'
...
export default {
  Mutation: {
    toggleCheckShoppingListFood: async (
      ...
      toggleCheckShoppingListFood(ctx.prisma, toggleCheckShoppingListFoodInput),
  },
}
