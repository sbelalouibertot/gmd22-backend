...
import { shutdown, clear, seedUser, seedEvent, seedShoppingList, seedShoppingListEvent } from '../../../../prisma/seed/seed'
...
describe('Toggle check shopping list food', () => {
    ...
    const eventsData: Prisma.EventCreateInput[] = [
        ...
        { id: 'event_7', type: 'SHOPPING', date: new Date("2022-01-10T00:00:00.000Z"), user: { connect: { id: ids.user_1 } } },
    ]
    ...
    const shoppingListEventsData: Prisma.ShoppingListEventCreateInput[] = [
        { id: ids.shoppingListEvent_1, event: { connect: { id: 'event_3' } }, shoppingList: { connect: { id: ids.shoppingList_1 } } },
        { id: 'shopping_list_event_2', event: { connect: { id: 'event_7' } }, shoppingList: { connect: { id: 'shopping_list_2' } } }
    ]
